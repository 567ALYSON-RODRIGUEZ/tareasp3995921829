...
public class Totito {
    ...
    //Incio cambios segunda parte Alyson Rodríguez 9959-21-829
        ...
        switch (itipoJugadaGanadora) {
            case 1:
                if (csimboloJugador == cprimerJugador) {
                    System.out.println("Ha ganado el Jugador 1 por completación de línea");
                } else {
                    System.out.println("Ha ganado el Jugador 2 por completación de línea");
                }
 
                break;
            case 2:
                if (csimboloJugador == cprimerJugador) {
                    System.out.println("Ha ganado el Jugador 1 por completación de columna");
                } else {
                    System.out.println("Ha ganado el Jugador 2 por completación columna");
                }
                break;
            case 3:
                if (csimboloJugador == cprimerJugador) {
